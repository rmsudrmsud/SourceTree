...
<form action="${pageContext.request.contextPath }/download/edit.do?num=${vo.num}" method="post" name="f">
<table border="1">
...
<tr><th>자료</th><td><a href="${pageContext.request.contextPath }/download/down.do?fname=${vo.down_path }&num=${vo.num}">${vo.down_path }</a></td></tr>
<tr><th>자료 다운로드수</th>
<td>${vo.down_cnt }</td></tr>
<c:if test="${sessionScope.loginId == vo.writer }">
<tr><th>수정</th><td><input type="submit" value="수정">
<a href="${pageContext.request.contextPath }/download/del.do?num=${vo.num}"><input type="button" value="삭제"></a></td></tr>
</c:if>
</table>
