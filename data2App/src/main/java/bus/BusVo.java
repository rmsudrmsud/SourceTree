...
public class BusVo {
	...
	public BusVo(String busRouteId, String busRouteNm, String corpNm, String stStationNm, String edStationNm,
			String term, String firstBusTm, String lastBusTm) {
	...
	public String toString() {
		return "BusVo [busRouteId=" + busRouteId + ", busRouteNm=" + busRouteNm + ", corpNm=" + corpNm
				+ ", stStationNm=" + stStationNm + ", edStationNm=" + edStationNm + ", term=" + term + ", firstBusTm="
				+ firstBusTm + ", lastBusTm=" + lastBusTm + "]";
	}
