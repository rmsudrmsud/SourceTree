...
<%-- 		<input type="button" value="질문목록" onclick="location.href='${pageContext.request.contextPath }/index.jsp" style="color:black; font-family: sans-serif; margin-bottom:10px;"> --%>
<!-- 	</div> -->
	
	
<c:if test = "${sessionScope.loginId != null }">
<div class="quesionadd" style="margin-left:1227px;">
		<input type="button" value="질문추가" onclick="location.href='${pageContext.request.contextPath }/question/add.do'" style="color:black; font-family: sans-serif; margin-bottom:10px;">
	</div>
	</c:if>
...
<%-- 		<input type="hidden" name="city_num" value="${sessionScope.city_num }">  --%>
		<input type="submit" value="검색" style="color:black; font-family: sans-serif;">
	</form>
	</div>
</div>
